            ...
            <div class="product-details">
                ...
                <div class="specs-container">
                    ...
                    <div class="specs-grid">
                        <div class="spec-item">
                            <div class="spec-label">Jenis Produk</div>
                            <div class="spec-value" id="type">Pulpen Standard</div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-label">Material</div>
                            <div class="spec-value" id="material">Plastik, Tinta</div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-label">Fungsi</div>
                            <div class="spec-value" id="function">Alat tulis untuk dokumen</div>
                        </div>
                        <div class="spec-item">
                            <div class="spec-label">Fitur</div>
                            <div class="spec-value" id="features">Tinta cepat kering, nyaman digenggam</div>
                        </div>
                    </div>
                </div>
            </div>

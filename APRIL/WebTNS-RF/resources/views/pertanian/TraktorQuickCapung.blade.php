...
@section('title', 'Traktor Quick Capung - Tricipta Niaga Sukses')
    ...
    <div class="product-detail-container">
        ...
        <div class="product-content">
            <div class="product-image-container">
                <img src="{{ asset('images/tractor.png') }}" alt="Traktor Quick Capung" class="product-image">
            </div>
            
            <div class="product-details">
                <div class="product-description">
                    <p>Traktor Quick Capung adalah traktor tangan serbaguna yang tangguh dan efisien untuk berbagai kebutuhan pertanian. Dilengkapi mesin bertenaga, mudah dioperasikan, serta hemat bahan bakar, cocok untuk mengolah lahan, membajak, dan aktivitas pertanian lainnya.</p>
                </div>

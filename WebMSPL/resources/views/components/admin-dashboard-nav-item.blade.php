...
<a href="{{ $href }}" target="{{ $target }}"
   ...
   class="group relative flex items-center gap-3 px-3 py-2 rounded-xl text-[13.5px] font-hanken font-medium transition-all duration-150
    {{ $active
        ? 'text-white'
    ...
    {{-- Icon box --}}
    <span class="relative w-[30px] h-[30px] rounded-lg flex items-center justify-center shrink-0 text-[12px] transition-all duration-150
        {{ $active

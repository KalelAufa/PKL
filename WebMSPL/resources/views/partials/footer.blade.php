        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class="sm:col-span-2 lg:col-span-4 flex flex-col gap-6">
                ...
                <div class="flex gap-3 pt-2">
                    <a href="{{ $footerContent['social_linkedin']->value ?? '#' }}"
                       ...
                       class="w-10 h-10 flex items-center justify-center bg-msp-white-alpha rounded-xl transition-all duration-300 hover:bg-msp-gold hover:scale-110" aria-label="LinkedIn">
                    ...
                    <a href="{{ $footerContent['social_instagram']->value ?? '#' }}"
                       ...
                       class="w-10 h-10 flex items-center justify-center bg-msp-white-alpha rounded-xl transition-all duration-300 hover:bg-msp-gold hover:scale-110" aria-label="Instagram">
                    ...
                    <a href="{{ $footerContent['social_facebook']->value ?? '#' }}"
                       ...
                       class="w-10 h-10 flex items-center justify-center bg-msp-white-alpha rounded-xl transition-all duration-300 hover:bg-msp-gold hover:scale-110" aria-label="Facebook">
                    ...
                    <a href="{{ $footerContent['social_x']->value ?? '#' }}"
                       ...
                       class="w-10 h-10 flex items-center justify-center bg-msp-white-alpha rounded-xl transition-all duration-300 hover:bg-msp-gold hover:scale-110" aria-label="X">
            ...
            <div class="lg:col-span-2 flex flex-col gap-6">
                ...
                <ul class="flex flex-col gap-3 md:gap-4">
                    <li><a href="{{ url('/') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Beranda</a></li>
                    <li><a href="{{ url('/tentang-kami') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Tentang Kami</a></li>
                    <li><a href="{{ url('/layanan') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Layanan</a></li>
                    <li><a href="{{ url('/berita') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Berita</a></li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-3 flex flex-col gap-6">
                ...
                <ul class="flex flex-col gap-3 md:gap-4">
                    <li><a href="{{ route('service.detail', 'outsourcing') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Jasa Outsourcing</a></li>
                    <li><a href="{{ route('service.detail', 'perizinan-lingkungan') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Perizinan Lingkungan</a></li>
                    <li><a href="{{ route('service.detail', 'pest-control') }}" class="text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1 inline-block">Pest Control</a></li>
                    <li><a href="https://tns.co.id" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2 text-[rgba(220,226,243,0.8)] text-sm md:text-base transition-all duration-300 hover:text-white hover:translate-x-1">Pengadaan Barang (PT TNS) <i class="fas fa-external-link-alt text-[10px]"></i></a></li>
                </ul>
            </div>
            ...
            <div class="sm:col-span-2 lg:col-span-3 flex flex-col gap-6">
                ...
                <ul class="flex flex-col gap-3 md:gap-4">
                    <li class="flex items-start gap-3 transition-all duration-300 hover:translate-x-1">
    ...
    <div class="flex flex-col border-t border-msp-white-alpha mt-10 lg:mt-16">
        <div class="max-w-[1302px] mx-auto w-full px-6 py-6 md:py-8 flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex gap-4 md:gap-6">
                <a href="{{ url('/kebijakan-privasi') }}" class="text-[rgba(220,226,243,0.6)] text-xs md:text-sm transition-all duration-300 hover:text-white">Kebijakan Privasi</a>
            </div>
        </div>
    </div>
</footer>
